...
SESSION_CONFIGS = [
    ...
    {
        'name': 'PD_public',
        'display_name': "PD Public Monitoring ",
        'num_demo_participants': 6,
        'treatment': 'PBL',
        'debug': DEBUG,
        'app_sequence': ['my_PD_quiz', 'my_PD_practice', 'my_PD', 'coordination', 'my_PD_survey', 'ravens',
                         'investment_task', 'payment_info'],
    },
    {
        'name': 'PD_private',
        'display_name': "PD Private Monitoring ",
        'num_demo_participants': 4,
        'treatment': 'PRV',
        'debug': DEBUG,
        'app_sequence': ['my_PD_quiz', 'my_PD_practice', 'my_PD', 'coordination', 'my_PD_survey', 'ravens',
                         'investment_task', 'payment_info'],
        'app_sequence': ['my_PD_quiz', 'my_PD_practice', 'my_PD', 'coordination', 'ravens',
                         'investment_task', 'payment_info'],
    },
    {
        'name': 'PD_test',
